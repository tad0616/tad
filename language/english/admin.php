...
define('_OXYGEN_CLEAR_CACHE', 'Clear cache');
define('_OXYGEN_DEBUG_ENABLE', 'PHP Debug');
define('_OXYGEN_DEBUG_UNABLE', 'Close Debug');
define('_OXYGEN_DATABASE', 'Adminer');
define('_OXYGEN_OVERVIEW', 'Tools and overview');
define('_OXYGEN_SYS_CONFIG', 'System config');
